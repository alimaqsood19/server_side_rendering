...
app.get('*', function (req, res) {
  var store = (0, _createStore2.default)(); //redux store for the server side, some logic to initialize and load data into the store before passing to the renderer function
  ...
  res.send((0, _renderer2.default)(req, store)); //Calls our renderer function, which  renders the Home component into a string, stick into our
